...
\author{\vspace{-3em}Alex Martínez Ascensión}
\date{}
\makeatletter
...
\begin{document}
	...
	\subsection*{Leyenda}
	\vspace*{-1em}
	\obligatorio $\quad$ Demostración que ha caído en exámenes de hasta hace 3 años o que sale en la guía.
	
	\subsection*{Nota}
	\vspace*{-1em}
	\importante Este resumen está basado en la versión del libro base de 2014. Los cambios son mínimos, como la inclusión del tema \textit{Geometría analítica} en el resto de temas.
	...
	\input{3.tex}\end{multicols*}\pagebreak
	
	
	\begin{multicols*}{2}
	[\section{Ángulos}]
	\input{4.tex}\end{multicols*}\pagebreak
	
		
	\begin{multicols*}{2}
	[\section{Teorema de Tales}]
	\input{5.tex}\end{multicols*}\pagebreak
	
	
	\begin{multicols*}{2}
	[\section{Teorema de Pitágoras}]
	\input{6.tex}\end{multicols*}\pagebreak
	

	\begin{multicols*}{2}
	[\section{Semejanzas}]
	\input{7.tex}\end{multicols*}\pagebreak
	
	\begin{multicols*}{2}
	[\section{Circunferencias}]
	\input{8.tex}\end{multicols*}\pagebreak
	
	\begin{multicols*}{2}
	[\section{Geometría hiperbólica}]
	\input{9.tex}\end{multicols*}\pagebreak
	
	\begin{multicols*}{2}
	[\section{Polígonos}]
	\input{10.tex}\end{multicols*}\pagebreak
	
	\begin{multicols*}{2}
	[\section{Geometría euclidiana espacial}]
	\input{11.tex}\end{multicols*}\pagebreak
	...
	\input{12.tex}\end{multicols*}\pagebreak
	
	\begin{multicols*}{2}
	[\section{Poliedros}]
	\input{13.tex}\end{multicols*}\pagebreak	

	\begin{multicols*}{2}
	[\section{Geometría analítica}]
	\input{14.tex}\end{multicols*}\pagebreak	
